class DataValues {
  ...
  static const String appDescription =
      ...
      'expand upon, and keep my solutions running because I always love to try new technologies and stuff to create, build, '
      'test, develop, and maintain solutions to problems. '
      'So, there are so many technologies and tools that are existing or newly emerging. '
      'Yes, I\'m still figuring out how to use technology as best I can, and I enjoy attempting to use it to '
      'make my life easier while also helping others.';
